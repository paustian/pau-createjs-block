...
$assets_base_url     = esc_url( dirname( $pau_full_javascript_url ) . '/' );
	...
	if ( ! wp_script_is( $pau_handle, 'enqueued' ) ) {
		...
		$inline_script = "
            window.addEventListener( 'load', function() {
                ...
                " . esc_js( $pau_init_func  ) . "('" . esc_js( $assets_base_url ) . "');
            } );
        ";
		wp_add_inline_script( $pau_handle, $inline_script );
	}
}
$pau_allowed_tags = array(
	'b' => array(),
	'em' => array(),
	'strong' => array(),
	'u' => array(),
...
<p class="figure-border-createjs-block"><?php echo wp_kses( $pau_description, $pau_allowed_tags ); ?></p>
